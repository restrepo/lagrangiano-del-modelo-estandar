...
\widetilde{\Phi}=&
  ...
  \end{pmatrix}\,.
\end{align}
The ``$\pm$'' and 0 superindexes are just for later convenience, with $\left( \phi^+ \right)^{*}=\phi^-$
...
\begin{align*}
  Y_L+Y_{\widetilde{\Phi}}-Q_{e_R}=&0\\
  Y_Q+Y_{\widetilde{\Phi}}-Q_{d_R}=&0\\
  Y_Q+Y_{\Phi}-Y_{u_R}=Y_Q-Y_{\widetilde{\Phi}}-Q_{u_R}=&0\,,
\end{align*}
...
\nonumber\\
     ...
     &- \left[  h_e \left( e_R \right)^{\dagger}\,\epsilon^{ab}L_a\widetilde{\Phi}_b +
      h_d \left( d_R \right)^{\dagger}\,\epsilon^{ab}Q_a\widetilde{\Phi}_b +
      h_u \left( u_R \right)^{\dagger}\,\epsilon_{ab}Q_a{\Phi}_{b}+\text{h.c}\right]\nonumber\\
...
\mathcal{L}_{\text{Yukawa}}=&- \left[  h_e \left( e_R \right)^{\dagger}\,\epsilon^{ab}L_a\widetilde{\Phi}_b +
      h_d \left( d_R \right)^{\dagger}\,\epsilon^{ab}Q_a\widetilde{\Phi}_b +
      h_u \left( u_R \right)^{\dagger}\,\epsilon_{ab}Q_a{\Phi}_{b}+\text{h.c}\right]
\end{align}
