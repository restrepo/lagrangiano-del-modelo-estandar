...
Comenzaremos analizando una versión simplificada del Lagrangiano con sólo los leptones de la primera de la primera generación, 
\begin{align}
...
\begin{align}
 ...
 \left(  -\frac{1}{2}g_2 s_W +g_1 c_W Y_L \right) e_L
  \end{pmatrix}
\end{align}
Igualando los coeficientes que acompañanan los campos resultan las dos condiciones
\begin{align}
  \label{eq:g2sw}
...
\end{align}
con estas condiciones podemos despejar tres incognitas que corresponden a $g_1c_W$, $g_2s_W$ y $Y_L$.
La primera de ellas la podemos obtener de 
igualar los coeficientes que acompañanam los campos para la tercera condición, teniendo en cuenta que $\widehat{Q}=\widehat{Y}$ para los campos que no sienten la interacción
debil asociada a $\operatorname{SU}(2)_L$
\begin{align}
  e=g_1 c_W\,.
\end{align}
...
\begin{align}
  g_2 s_W = -2e Y_L\,,
\end{align}
y reemplzando ambos resultado en \eqref{eq:YL}
\begin{align}
...
+\frac{e}{2c_W s_W} \left( e_R \right)^{\dagger}{\sigma}^\mu\left[ 0-2s_W^2\widehat{Q}\right]e_R\, Z_\mu\,.
\end{align}
Como las expresiones están en términos de los generadores sin evaluar deben ser válidas para los otros conjuntos apropiados de fermiones.
