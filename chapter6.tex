...
\begin{align}
  \Xi_1^{\dagger}\Phi\eta^{\dagger}_1+\text{h.c}=&L^{\dagger}\Phi e_R+\text{h.c} \nonumber\\
   =&\begin{pmatrix}
     \nu_L^{\dagger} & e_L^{\dagger}
   \end{pmatrix}
   \begin{pmatrix}
...
\nonumber\\
     ...
     &-(h_e L^{\dagger}\Phi e_R+h_d Q^{\dagger}\Phi d_R+h_u Q^{\dagger}\widetilde{\Phi}u_R+\text{h.c})\nonumber\\
...
\begin{align}
  \label{eq:azl}
      \mathcal{L}_{A Z L}\to\sum_{F=Q,L,e_R,d_R,u_R}\frac{e}{2c_W s_W}\overline{F}\Sigma^\mu\left[ \tau_3-2s_W^2\widehat{Q}_L\right]F Z_\mu
       +e\overline{F}\Sigma^\mu \widehat{Q}_L F A_\mu\,,
\end{align}
donde $\Sigma^{\mu}=\overline{\sigma}^{\mu}$ para $F=Q,L$ y $\Sigma^{\mu}={\sigma}^{\mu}$ para $F=e_R,d_R,u_R$.
...
&+g_s \left({u_L}^{\dagger}\gamma_\mu\frac{\lambda^a}{2}u_L+{u_R}^{\dagger}\gamma_\mu\frac{\lambda^a}{2}u_R
+{d_L}^{\dagger}\gamma_\mu\frac{\lambda^a}{2}d_L+ {d_R}^{\dagger}\gamma_\mu\frac{\lambda^a}{2}d_R\right)G^\mu_a\nonumber\\
&+\frac{g}{\sqrt{2}}\left[\overline{\nu_L}\gamma^\mu e_LW_\mu^++
{u_L}^{\dagger}\gamma^\mu d_LW_\mu^++\text{h.c}\right]\nonumber\\
&+\sum_{F=Q,L,e_R,d_R,u_R}\frac{e}{2c_W s_W}\overline{F}\gamma^\mu\left[ \tau_3-2s_W^2\widehat{Q}_L\right]F Z_\mu\nonumber\\
&+e\left({e_L}^{\dagger}\gamma^\mu \widehat{Q}_e e_L+{e_R}^{\dagger}\gamma^\mu \widehat{Q}_e e_R\right.\nonumber\\
  &\qquad\left.+{u_L}^{\dagger}\gamma^\mu \widehat{Q}_u u_L+{u_R}^{\dagger}\gamma^\mu \widehat{Q}_u u_R
+{d_L}^{\dagger}\gamma^\mu \widehat{Q}_d d_L+{d_R}^{\dagger}\gamma^\mu \widehat{Q}_d d_R\right) A_\mu\,.
\end{align}
...
\item
  \begin{align}
\label{eq:zf4}
    &\left[ Q^{\dagger}\gamma^\mu\left( \tau_3-2s_W^2\widehat{Q}_Q\right)Q
      -2s_W^2{u_R}^{\dagger}\gamma^\mu\widehat{Q}_u u_R-2s_W^2{d_R}^{\dagger}\gamma^\mu\widehat{Q}_d d_R\right]Z_\mu\nonumber\\
=&\left[\begin{pmatrix}
    ...
    \begin{pmatrix}
      ...
      d_L\\
    \end{pmatrix}\right.\nonumber\\
    &\left.-2s_W^2{u_R}^{\dagger}\gamma^\mu\widehat{Q}_u u_R-2s_W^2{d_R}^{\dagger}\gamma^\mu\widehat{Q}_d d_R
  \right]Z_\mu\nonumber\\
    =&\left\{{u_L}^{\dagger}\gamma^\mu u_L-{d_L}^{\dagger}\gamma^\mu d_L
-2s_W^2\left[\left(\overline{u_L}+{u_R}^{\dagger}\right)\gamma^\mu Q_u\left(u_L+u_R\right)
+\left(\overline{d_L}+{d_R}^{\dagger}\right)\gamma^\mu Q_d\left(d_L+d_R\right)
\right]\right\}Z_\mu \nonumber\\
...
\begin{align}
\label{eq:265qft} 
    \mathcal{L}=&i\sum_i\left( Q^{\prime\dagger}_i\gamma^\mu\mathcal{D}_\mu Q'_i+ L^{\prime\dagger}_i\gamma^\mu\mathcal{D}_\mu L'_i+
...
\begin{align}
  \overline{u_L}'_i \gamma^\mu{d_L}'_i=&{u_L}^{\dagger}_k\gamma^\mu({V^U_L}^\dagger)_{ki}(V^D_L)_{il} {d_L}_l\nonumber\\
  =&V_{kl}{u_L}^{\dagger}_k\gamma^\mu{d_L}_l\nonumber\\
...
\begin{align}
   \overline{u_L}'_i \gamma^\mu{u_L}'_i=&{u_L}^{\dagger}_k\gamma^\mu({V^U_L}^\dagger)_{ki}(V^U_L)_{il} {u_L}_l\nonumber\\
  =&\delta_{kl}{u_L}^{\dagger}_k \gamma^\mu{u_L}_l\nonumber\\
  =&{u_L}^{\dagger}_k\gamma^\mu {u_L}_k
 \end{align}
