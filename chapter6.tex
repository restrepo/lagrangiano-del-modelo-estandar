...
\begin{align}
  \label{eq:lfermion}
  \mathcal{L}_{\text{fermion}}=&i Q^{\dagger}\gamma^\mu\mathcal{D}_\mu Q+i L^{\dagger}\gamma^\mu\mathcal{D}_\mu L+
...
\begin{align}
  i L^{\dagger}\gamma^\mu\mathcal{D}_\mu L-i L^{\dagger}\gamma^\mu\partial_\mu L
=&i L^{\dagger}\gamma^\mu(-i g T_iW_\mu^i-i g'\,Y_LB_\mu) L\nonumber\\
=& L^{\dagger}\gamma^\mu(g T_1W_\mu^1+ g T_2W_\mu^2+g T_3W_\mu^3+g'\,Y_LB_\mu) L\nonumber\\
=& L^{\dagger}\gamma^\mu\left[\frac{g}{\sqrt{2}}
  \begin{pmatrix}
0 & W_\mu^+\\
W_\mu^- & 0\\    
  \end{pmatrix}
...
\right]L\nonumber\\
=&i L^{\dagger}\gamma^\mu\frac{g}{\sqrt{2}}
  \begin{pmatrix}
0 & W_\mu^+\\
W_\mu^- & 0\\    
  \end{pmatrix}L+
 L^{\dagger}\gamma^\mu\left[g T_3W_\mu^3+g'\,Y_LB_\mu
\right]L\nonumber\\
  =& L^{\dagger}\gamma^\mu\frac{g}{\sqrt{2}}
  \begin{pmatrix}
e_LW_\mu^+\\
\nu_L W_\mu^-\\    
...
\overline{e_L}\gamma^\mu\nu_L W_\mu^-\right]\nonumber\\    
  \mathcal{L}_{A Z L}=& L^{\dagger}\gamma^\mu\left[g T_3W_\mu^3+g'\,Y_LB_\mu\right]L
\end{align}
...
\begin{align}
   \mathcal{L}_{A Z L}=& L^{\dagger}\gamma^\mu\left[g T_3(c_W Z_\mu+s_W A_\mu)+g'\,Y_L(-s_W Z_\mu+c_W A_\mu)\right]L\nonumber\\
     =& L^{\dagger}\gamma^\mu\left[g T_3c_W Z_\mu+g T_3s_W A_\mu-g'\,Y_Ls_W Z_\mu+g'\,Y_Lc_W A_\mu\right]L\nonumber\\
    =& L^{\dagger}\gamma^\mu\left[\left(g c_WT_3-g's_W\,Y_L\right)Z_\mu
...
\begin{align}
    \mathcal{L}_{A Z L}=& L^{\dagger}\gamma^\mu\left[\left(g c_WT_3-g \frac{s_W^2}{c_W}\,Y_L\right)Z_\mu
       +\left(g s_W T_3+g s_W\,Y_L\right) A_\mu\right]L\nonumber\\
=&g s_W L^{\dagger}\gamma^\mu\left[\left(\cot\theta_WT_3- \tan\theta_W\,Y_L\right)Z_\mu
...
\begin{align}
    \mathcal{L}_{A Z L}
=&e L^{\dagger}\gamma^\mu\left(\cot\theta_W T_3-\tan\theta_W\,Y_L\right)L Z_\mu
       +e L^{\dagger}\gamma^\mu \widehat{Q}_L L A_\mu\nonumber\\
=&e L^{\dagger}\gamma^\mu\left[\cot\theta_W T_3-\tan\theta_W\left(\widehat{Q}_L-T_3\right)\right]L Z_\mu
       +e L^{\dagger}\gamma^\mu \widehat{Q}_L L A_\mu\nonumber\\
=&\frac{e}{2c_W s_W} L^{\dagger}\gamma^\mu\left[ \tau_3-2s_W^2\widehat{Q}_L\right]L Z_\mu
       +e L^{\dagger}\gamma^\mu \widehat{Q}_L L A_\mu\,.
\end{align}
