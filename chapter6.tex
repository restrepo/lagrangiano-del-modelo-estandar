...
\begin{align}
\label{eq:devLW}
  i \widetilde{L}\cdot\overline{\sigma}^\mu\mathcal{D}_\mu L
=&i \widetilde{L}\cdot\overline{\sigma}^\mu\partial_\mu L+i{e_R}^{\dagger}\sigma^\mu\partial_\mu {e_R}+
 i \widetilde{L}\cdot\overline{\sigma}^\mu(-i g T_iW_\mu^i-i g'\,Y_LB_\mu) L + i{e_R}^{\dagger}\sigma^\mu \left( -ig' Y_E B_{\mu} \right) {e_R}\nonumber\\
=& \widetilde{L}\cdot\overline{\sigma}^\mu(g T_1W_\mu^1+ g T_2W_\mu^2+g T_3W_\mu^3+g'\,Y_LB_\mu) L+ g' Y_E{e_R}^{\dagger}\sigma^\mu  {e_R} B_\mu\nonumber\\
=&i \widetilde{L}\cdot\overline{\sigma}^\mu\partial_\mu L+i{e_R}^{\dagger}\sigma^\mu\partial_\mu {e_R}+ \widetilde{L}\cdot\overline{\sigma}^\mu\left[\frac{g}{\sqrt{2}}
  \begin{pmatrix}
0 & W_\mu^+\\
W_\mu^- & 0\\    
  \end{pmatrix}
+g T_3W_\mu^3+g'\,Y_LB_\mu
\right]L+ g' Y_E{e_R}^{\dagger}\sigma^\mu  {e_R} B_\mu\nonumber\\
=&i \widetilde{L}\cdot\overline{\sigma}^\mu\partial_\mu L+i{e_R}^{\dagger}\sigma^\mu\partial_\mu {e_R}+i \widetilde{L}\cdot\overline{\sigma}^\mu\frac{g}{\sqrt{2}}
  \begin{pmatrix}
0 & W_\mu^+\\
W_\mu^- & 0\\    
  \end{pmatrix}L+
...
\right]L+ g' Y_E{e_R}^{\dagger}\sigma^\mu  {e_R} B_\mu\nonumber\\
  =&i \widetilde{L}\cdot\overline{\sigma}^\mu\partial_\mu L+i{e_R}^{\dagger}\sigma^\mu\partial_\mu {e_R}+ \frac{g}{\sqrt{2}}\widetilde{L}\cdot\overline{\sigma}^\mu
  \begin{pmatrix}
e_LW_\mu^+\\
\nu_L W_\mu^-\\    
...
donde
\begin{align}
  \mathcal{L}_{A Z L}=& \widetilde{L}\cdot\overline{\sigma}^\mu\left[g T_3W_\mu^3+g'\,Y_LB_\mu\right]L+ g' Y_E{e_R}^{\dagger}\sigma^\mu  {e_R} B_\mu\,.
\end{align}
Teniendo en cuenta que 
\begin{align}
...
\end{align}
De esto modo, la simetría gauge genera la interacción deseada con los bosones gauge cargados $W_{\mu}^{\pm}$. Sin embargo, se generan muchas otras interacciones de las cuales deben contener apropiadamente la interacción electromagnética en algún cambio de base.
...
\begin{align}
 \mathcal{D}_\mu &=  \begin{pmatrix}
    \partial_\mu-i\left(\frac{1}{2}g W^3_\mu+{\color{red}g' Y B_\mu}\right)&-\frac{i}{\sqrt{2}}g W^+_\mu\\
    -\frac{i}{\sqrt{2}}g W^-_\mu&\partial_\mu-i\left(-\frac{1}{2}g W^3_\mu+{\color{red}g'Y B_\mu}\right)
  \end{pmatrix}.
\end{align}
...
\mathcal{D}_\mu \begin{pmatrix}
  ...
  \end{pmatrix}=\begin{pmatrix}
    ...
    \partial_\mu H-i\left(-\frac{1}{2}gW^3_\mu+{\color{red}g'Y_{\widetilde{\Phi}} B_\mu}\right)(H+v)
  \end{pmatrix}.
\end{align}
...
=&\frac{1}{2}\begin{pmatrix}
 ...
 =&-V(H)
  ...
  &+\frac{1}{2}\partial^\mu H\partial_\mu H+\frac{1}{2}\left(-\tfrac{1}{2}gW_3^\mu+{\color{red}g'Y_{\widetilde{\Phi}} B^\mu}\right)^2(H+v)^2
\end{align}
