...
\begin{align}
 ...
 \left(  -\frac{1}{2}g_2 s_W +g_1 c_W Y_L \right) e_L
  \end{pmatrix}
\end{align}
Igualando campos, tenemos las condiciones
\begin{align}
...
\end{align}
E igualando de nuevo los campos teniendo en cuenta que $e_R=Y$
\begin{align}
  e=g_1 c_W\,.
\end{align}


Ya que las partículas derechas no participan de la interacción débil generada por $\operatorname{SU}(2)_L$, su carga eléctrica debe coincidir con la hipercarga, es decir,
$Q_e=Y_R$. Por lo tanto, de la ec.\eqref{eq:erel}
\begin{align}
  e=g_1\cos\theta_W\,.
\end{align}
...
debemos encontrar los valores numérico para $Y_L$ y $Y_R$. Partiendo de la relación de Gell-Mann--Nishijima \eqref{eq:gn}
\begin{align}
