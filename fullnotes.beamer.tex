...
\mode<presentation>{\input{chapter1}}
\mode<presentation>{\input{chapter2}}
\mode<presentation>{\input{chapter4}}
\mode<presentation>{\input{chapter3}}
\mode<presentation>{\input{chapter5}}
\mode<presentation>{\input{kirchhoff}}
\mode<presentation>{\input{chapter6}}
