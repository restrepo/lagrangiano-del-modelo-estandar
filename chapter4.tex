...
\begin{align}
  \phi(x)=\frac{\varphi(x)}{\sqrt{2}} \operatorname{e}^{i\bar{G}(x)}\,,
\end{align}
...
=&\frac{1}{2}\left( \partial^{\mu}\varphi-i\varphi \partial^{\mu}\bar{G} \right)^{*}\left(\partial_{\mu}\varphi+i\varphi \partial_{\mu}\bar{G}  \right)
-\frac{1}{2}\mu^2 \varphi^2 -\frac{1}{4}\varphi^4 \nonumber\\
=&\frac{1}{2}\partial^{\mu}\varphi\partial_{\mu}\varphi+\frac{1}{2}\varphi^2 \partial^{\mu}\bar{G}\partial_{\mu}\bar{G} 
-\frac{1}{2}\mu^2 \varphi^2 -\frac{1}{4}\varphi^4 \,.
\end{align}
 Como $\varphi^2=\phi_1^2+\phi_2^2$, el módulo del campo complejo, podemos expandirlo  alrededor del campo que oscila en mínimo en el modo que sube por las paredes, como se describió en la fig.~\ref{fig:mexicanhat}. Hacemos entonces el cambio de variables
 \begin{align}
   \varphi(x)=H(x)+v\,,
 \end{align}
tal que $|\varphi_{\text{min}}|=v$. Reemplazando en el Lagrangiano anterior tenemos que
\begin{align}
  \mathcal{L}=&\frac{1}{2}\partial^{\mu}H\partial_{\mu}H+\frac{1}{2}\partial^{\mu}G\partial_{\mu}G+\frac{H}{v}\partial^{\mu}G\partial_{\mu}G
-\tfrac{1}{2}\mu^2(H+v)^2-\tfrac{1}{4}\lambda(H+v)^4 \nonumber\\
=&  \frac{1}{2}\partial^{\mu}H\partial_{\mu}H+\frac{1}{2}\partial^{\mu}G\partial_{\mu}G+\frac{H}{v}\partial^{\mu}G\partial_{\mu}G-\frac{1}{2}m_H^2H^2-\frac{1}{2}\frac{m_H^2}{v}H^3-\frac{1}{8}\frac{m_H^2}{v^2} H^4\,,
\end{align}
...
\end{align}
que predice que el campo $H$ debe decaer a dos campos $G$. Sin embargo, este tipo de procesos aún no se han observado en la naturaleza. 
...
\begin{align*}
  \phi(x)=\frac{\varphi(x)}{\sqrt{2}}e^{i\bar{G}(x)}
\end{align*}
Expandiendo el campo $\varphi(x)$ alrededor del mínimo: $\varphi(x)=(H(x)+v)$, tenemos
\begin{align*}
