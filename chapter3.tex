...
\psi_{\dot{\beta}}^{\dagger}{\left[{S^{\dagger}(\Lambda)}\right]^{\dot{\beta}}}_{\dot{\alpha}}&& \text{Rigth-handed anti-spinor field,}\,,
 \end{align}
\end{frame}
...
Como un campo escalar no permite escribir un término en la densidad Lagrangiana con derivadas de primer orden (see eq.~\eqref{eq:nolor}), debemos usar
