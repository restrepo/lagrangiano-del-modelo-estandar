...
\end{english}
\begin{spanish}
Consideremos primero un grupo más simple, el correspondiente a las rotaciones en tres dimensiones. Los generadores osn los operadores de momento angular $ J^i$, que satisfacen las relaciones de conmutación
\end{spanish}
\begin{align}
\label{eq:rotgr}
...
We must build a representation of the Lorentz Group in  $n$ dimensions. In \cite{Peskin}:
\begin{quote}
