...
\end{align}
usando \eqref{eq:Dmup} da lugar a
\begin{align}
\label{eq:ugum}
...
Retornado a la definición la matriz de tensores de campos gauge para una teoría no Abeliana $\operatorname{SU}(3)$, tenemos entonces que
\begin{align}
  G_{\mu\nu}\equiv & \mathcal{D}_{\mu} G_{\nu}-\mathcal{D}_{\nu} G_{\mu} \nonumber\\
