...
El Lagrangiano de Dirac invariante gauge local se obtiene reemplazando la derivada normal por la derivada covariante. Para el campo electrónico $Q=-1$
\begin{align}
...
\end{align}
Este Lagrangia da lugar a una Acción que define una teoría completa correspondiente a
la electrodinámica cuántica (QED de sus siglas en ingles)
...
\begin{figure}
  \centering
  \includegraphics[scale=0.6]{feynmanrulesqed} % in feynmanrules.svf as a Layer
...
\begin{figure}
  \centering
  \includegraphics[scale=0.8]{qedrepulsion}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{polarization}
...
\begin{align}
  \widehat{H}\psi&=\frac{1}{2m}\left\{(i\boldsymbol{\nabla}+q\mathbf{A})^2\psi
    -q \sigma^k(\boldsymbol{\nabla}\times\mathbf{A})_k \phi\right\}+q A_0\psi\nonumber\\
...
%Logica actual:
% 1 G es campo de materia defina derivada covariante
...
En el caso de los tensores cromodinámicos, tenemos
\begin{align}
